            ...
            <div
                ...
                <div class="w-full md:w-1/2">
                    <div class="mb-10 lg:mb-20">
                        <svg id='logoipsum' xmlns='http://www.w3.org/2000/svg' viewBox='15 30 147.778 40' class="w-48">
                            ...
                            <path d='M152,50.03v6.078h-2.97V50.287c0-.99-.475-1.623-1.425-1.623-.99,0-1.545.693-1.545,1.861v5.583h-2.969V50.287c0-.99-.475-1.623-1.426-1.623-.99,0-1.544.693-1.544,1.861v5.583h-2.97v-9.9h2.97v.91a3.039,3.039,0,0,1,2.653-1.187,2.945,2.945,0,0,1,2.593,1.306,3.262,3.262,0,0,1,2.871-1.306C150.511,45.932,152,47.555,152,50.03Z'
                                  fill='#0582C1' />
                            <circle cx='154.512' cy='43.944' r='2.204' fill='#0582C1' /></svg>
                    </div>
                    <div class="mb-10 md:mb-20 text-gray-600 font-light">
                        <h1 class="font-black uppercase text-3xl lg:text-5xl text-yellow-500 mb-10">你的页面已经上火星!
                        </h1>
                        <p>你的页面找不到</p>
                        <p>返回再找找</p>
                    </div>
                    <div class="mb-20 md:mb-0">
                        <a href="http://yhdengdeng.net/admin"
                           class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600"><i
                               class="mdi mdi-arrow-left mr-2"></i>回退</a>
                    </div>
                </div>
                <div class="w-full md:w-1/2 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.85 285.44"
                        ...
                        <g id="OBJECTS">
                            ...
                            <g>
                                ...
                                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="242.075" y1="248.234"
                                                x2="242.075" y2="224.179">
                                    <stop offset="0" stop-color="#fff" />
                                    <stop offset="1" stop-color="#fff" stop-opacity="0" />
                                </linearGradient>
                                <path class="st17" d="M171.96 222.56H312.2v14.94H171.96z" />
                                <ellipse transform="rotate(-9.249 191.082 198.565)" class="st6" cx="191.05" cy="198.49"
                                         rx="9.23" ry="9.23" />
                                <path class="st4"
                                ...
                                <ellipse transform="rotate(-9.249 292.07 198.575)" class="st6" cx="292.01" cy="198.49"
                                         rx="9.23"
                                         ry="9.23" />
                                <path class="st4"
                    ...
                    <a href="http://yhdengdeng.net/admin"
                       class="text-xs text-gray-300">快速营救:->http://yhdengdeng.net/admin</a>
                </div>
            </div>
            <div
